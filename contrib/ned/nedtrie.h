...
#ifndef NOINLINE
  #if defined(__GNUC__)
    #define NO__attribute__ ((noinline))
  #elif defined(_MSC_VER)
    #define NO__declspec(noinline)
  #else
    #define NOINLINE
  #endif
#endif
...
/*! \def DEBUGINLINE
\brief Defined to be when NDEBUG is defined, NOwhen DEBUG is defined, unset otherwise.
*/
#ifndef DEBUGINLINE
#ifdef NDEBUG
#define DEBUGINLINE
...
namespace {
#endif
static unsigned nedtriebitscanr(size_t value)
{
  if(!value) return 0;
...
#define NEDTRIE_GENERATE_NOBBLES(proto, name, type, field, keyfunct) \
  static int name##_nobblezeros(struct name *head) { return 0; } \
  static int name##_nobbleones(struct name *head) { return 1; } \
  static int name##_nobbleequally(struct name *head) { return (head->nobbledir=!head->nobbledir); }
#endif /* __cplusplus */
  ...
  template<class trietype, class type, size_t fieldoffset, size_t (*keyfunct)(const type *RESTRICT)> DEBUGvoid triecheckvalidity(trietype *head);
...
#ifdef __cplusplus
namespace nedtries {
  template<class trietype, class type, size_t fieldoffset, size_t (*keyfunct)(const type *RESTRICT)> DEBUGvoid trieinsert(trietype *RESTRICT head, type *RESTRICT r)
  {
...
#define NEDTRIE_GENERATE_INSERT(proto, name, type, field, keyfunct) \
  proto void name##_NEDTRIE_INSERT(struct name *RESTRICT head, struct type *RESTRICT r) \
  { \
...
#ifdef __cplusplus
namespace nedtries {
  template<class trietype, class type, size_t fieldoffset, size_t (*keyfunct)(const type *RESTRICT), int (*nobblefunct)(trietype *head)> DEBUGvoid trieremove(trietype *RESTRICT head, type *RESTRICT r)
  {
...
#define NEDTRIE_GENERATE_REMOVE(proto, name, type, field, keyfunct, nobblefunct) \
  proto void name##_NEDTRIE_REMOVE(struct name *RESTRICT head, struct type *RESTRICT r)		\
  { \
...
#ifdef __cplusplus
namespace nedtries {
  template<class trietype, class type, size_t fieldoffset, size_t (*keyfunct)(const type *RESTRICT)> DEBUGtype *triefind(const trietype *RESTRICT head, const type *RESTRICT r)
  {
...
#define NEDTRIE_GENERATE_FIND(proto, name, type, field, keyfunct) \
  proto struct type * name##_NEDTRIE_FIND(struct name *RESTRICT head, struct type *RESTRICT r)		\
  { \
    struct type *RESTRICT node, *RESTRICT childnode; \
    size_t rkey=keyfunct(r), keybit, nodekey; \
    unsigned bitidx; \
...
#ifdef __cplusplus
namespace nedtries {
  template<class trietype, class type, size_t fieldoffset, size_t (*keyfunct)(const type *RESTRICT)> DEBUGint trieexactfind(const trietype *RESTRICT head, const type *RESTRICT r)
  {
...
#define NEDTRIE_GENERATE_EXACTFIND(proto, name, type, field, keyfunct) \
  proto int name##_NEDTRIE_EXACTFIND(struct name *RESTRICT head, struct type *RESTRICT r)		\
  { \
...
#ifdef __cplusplus
namespace nedtries {
  template<class trietype, class type, size_t fieldoffset, size_t (*keyfunct)(const type *RESTRICT)> DEBUGtype *trieNfind(const trietype *RESTRICT head, const type *RESTRICT r)
  {
...
#define NEDTRIE_GENERATE_NFIND(proto, name, type, field, keyfunct) \
  proto struct type * name##_NEDTRIE_NFIND(struct name *RESTRICT head, struct type *RESTRICT r)		\
  { \
...
#ifdef __cplusplus
namespace nedtries {
  template<class trietype, class type, size_t fieldoffset, size_t (*keyfunct)(const type *RESTRICT)> DEBUGtype *trieminmax(const trietype *RESTRICT head, unsigned dir)
  {
...
#define NEDTRIE_GENERATE_MINMAX(proto, name, type, field, keyfunct) \
  proto struct type * name##_NEDTRIE_MINMAX(struct name *RESTRICT head, unsigned dir)		\
  { \
...
#ifdef __cplusplus
namespace nedtries {
  template<class trietype, class type, size_t fieldoffset, size_t (*keyfunct)(const type *RESTRICT)> DEBUGtype *trieprev(const trietype *RESTRICT head, const type *RESTRICT r)
  {
    const type *RESTRICT node=0, *RESTRICT child;
    const TrieLink_t<type> *RESTRICT nodelink, *RESTRICT rlink;
    unsigned bitidx;
...
#define NEDTRIE_GENERATE_PREV(proto, name, type, field, keyfunct) \
  proto struct type * name##_NEDTRIE_PREV(struct name *RESTRICT head, struct type *RESTRICT r)		\
  { \
    struct type *RESTRICT node=0, *RESTRICT child; \
    unsigned bitidx; \
\
...
#ifdef __cplusplus
namespace nedtries {
  template<class trietype, class type, size_t fieldoffset, size_t (*keyfunct)(const type *RESTRICT)> DEBUGtype *trienext(const trietype *RESTRICT head, const type *RESTRICT r)
  {
    const type *RESTRICT node;
    const TrieLink_t<type> *RESTRICT nodelink, *RESTRICT rlink;
    unsigned bitidx;
...
#define NEDTRIE_GENERATE_NEXT(proto, name, type, field, keyfunct) \
  proto struct type * name##_NEDTRIE_NEXT(struct name *RESTRICT head, struct type *RESTRICT r)		\
  { \
    struct type *RESTRICT node; \
    unsigned bitidx; \
\
...
#define NEDTRIE_GENERATE(proto, name, type, field, keyfunct, nobblefunct) \
  ...
  proto struct type * name##_NEDTRIE_PREVLEAF(struct type *r) { return (r)->field.trie_prev; } \
  proto struct type * name##_NEDTRIE_NEXTLEAF(struct type *r) { return (r)->field.trie_next; }
