...
bool D3D8RendererDevice::Initialize()
{
...
void D3D8RendererDevice::End() const
{
	pScreen->ApplyFade();
	mDevice->EndScene();
...
void D3D8RendererDevice::TextureDataUpdate(ITexture *texture)
{
	const void *data = texture->GetData();
	if (data)
	{
...
void D3D8RendererDevice::Update()
{
	if (mDevice)
	{
