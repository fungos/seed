...
void PackageManager::Add(const char *fileName, ResourceManager *res)
{
	ASSERT_NULL(fileName);
	ASSERT_NULL(res);

	Package *p = static_cast<Package *>(res->Get(fileName, Seed::ObjectPackage));
	if (p)
	{
...
const char *PackageManager::GetObjectName() const
{
