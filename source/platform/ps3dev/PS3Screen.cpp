...
bool Screen::MakeColorBuffer(RSXBuffer *buf, s32 bid)
{
...
bool Screen::MakeDepthBuffer(RSXBuffer *buf)
{
	int pitch = iWidth * sizeof(u32);
	int size = iHeight * pitch;
...
void Screen::SetRenderTarget(RSXBuffer *buf)
{
	gcmSurface sf;
